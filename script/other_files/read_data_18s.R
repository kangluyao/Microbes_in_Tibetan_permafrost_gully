...
# phylo_16s_rare <- phyloseq(otu_rare, tax, meta_dat, tree, ref.seqs)
sample_names(phylo_16s) <- metadata$Sample_name
# sample_names(phylo_16s_rare) <- metadata$Sample_name
phylo_16s_even = rarefy_even_depth(phylo_16s, sample.size = min(colSums(otu_16s)), rngseed = 1234, replace = TRUE)
...
# phylo_its_rare <- phyloseq(otu_rare, tax, meta_dat, tree, ref.seqs)
sample_names(phylo_its) <- metadata$Sample_name
# sample_names(phylo_its_rare) <- metadata$Sample_name
phylo_its_even = rarefy_even_depth(phylo_its, sample.size = min(colSums(otu_its)), rngseed = 1234, replace = TRUE)
...
# phylo_protist_rare <- phyloseq(otu_rare, tax, meta_dat, tree, ref.seqs)
sample_names(phylo_protist) <- metadata$Sample_name
# sample_names(phylo_protist_rare) <- metadata$Sample_name
phylo_protist_even = rarefy_even_depth(phylo_protist, sample.size = min(colSums(otu_pro)), rngseed = 1234, replace = TRUE)
...
# phylo_animal_rare <- phyloseq(otu_rare, tax, meta_dat, tree, ref.seqs)
sample_names(phylo_animal) <- metadata$Sample_name
# sample_names(phylo_animal_rare) <- metadata$Sample_name
phylo_animal_even = rarefy_even_depth(phylo_animal, sample.size = min(colSums(otu_anim)), rngseed = 1234, replace = TRUE)
