...
```{r}
env_vars <- c("Plant_richness", "pH", "Soil_moisture", "Clay.Silt", "WHC", "AGB", 
              "NH4_N", "NO3_N", "AP", "SOC")
...
Employe the Null model to infer the ecological processes underlying the community assembly.
```{r}
