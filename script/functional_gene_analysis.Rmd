...
Run the KEGG-decoder.py to determine the completion of pathways
```{python}
./script/KEGG-decoder.py -i kegg_decoder_collapsed_in.tsv -o KEGG_decoder_collapsed_output.tsv
```
