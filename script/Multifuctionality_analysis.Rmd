...
#remove Group ---> Plant_richness (P = 0.5907)
gully_sem_3 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
...
#remove Group ---> meanFunction (P = 0.4670)
gully_sem_4 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
  lme(Plant_richness ~ Soil_multidiv, random = ~1|Gully_id, data = sem_df, method = "ML"), 
  lme(Soil_multidiv ~ Group + Soil_PC1 + Plant_richness + Ric_kegg, random = ~1|Gully_id, data = sem_df, method = "ML"),
...
#remove Group ---> Ric_kegg (P = 0.3224)
gully_sem_5 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
  lme(Plant_richness ~ Soil_multidiv, random = ~1|Gully_id, data = sem_df, method = "ML"), 
  lme(Soil_multidiv ~ Group + Soil_PC1 + Plant_richness + Ric_kegg, random = ~1|Gully_id, data = sem_df, method = "ML"),
...
#remove Plant_richness ---> meanFunction (P = 0.3352)
gully_sem_6 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
  lme(Plant_richness ~ Soil_multidiv, random = ~1|Gully_id, data = sem_df, method = "ML"), 
  lme(Soil_multidiv ~ Group + Soil_PC1 + Plant_richness + Ric_kegg, random = ~1|Gully_id, data = sem_df, method = "ML"),
...
#remove Plant_richness ---> Soil_multidiv (P = 0.1656)
gully_sem_8 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
  lme(Plant_richness ~ Soil_multidiv, random = ~1|Gully_id, data = sem_df, method = "ML"), 
...
#remove Soil_PC1 ---> Soil_multidiv (P = 0.1656)
gully_sem_9 <- psem(
  lme(Soil_PC1 ~ Group, random = ~1|Gully_id, data = sem_df, method = "ML"),
  lme(Plant_richness ~ Soil_multidiv, random = ~1|Gully_id, data = sem_df, method = "ML"), 
