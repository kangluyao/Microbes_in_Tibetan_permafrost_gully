...
Anova(lme_fitn2o.block, type="III")
```
...
colnames(env_S1)<-colnames(metadata)[-c(1:4)]
data.frame(env_S1)
```
...
eff_siz_env_plot <- env_S1 %>%
  ...
  annotate("rect", xmin = 0, xmax = 8.5, ymin = -2, ymax = 2, alpha = 0.2,fill="#FAE3AD") +
  main_theme +
