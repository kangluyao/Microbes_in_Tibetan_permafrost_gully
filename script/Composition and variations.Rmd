...
marker_tab <- rbind(cbind(Taxa = rep("Bacteria", nrow(marker_16s)), marker_16s),
                    cbind(Taxa = rep("Fungi", nrow(marker_its)), marker_its),
                    cbind(Taxa = rep("Protist", nrow(marker_pro)), marker_pro),
                    cbind(Taxa = rep("Animal", nrow(marker_anim)), marker_anim))
marker_tab
```
