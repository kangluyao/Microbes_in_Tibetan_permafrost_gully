...
my_colors = c("#79ceb8", "#e95f5c", "#e4d00a", "#FB8072", "#FDB462", "#80B1D3", "#BEBADA", "#B3DE69", "#FCCDE5", "#A6CEE3",
...
sankey_plot <- sankeyNetwork(Links = links_datset, Nodes = nodes, 
                   ...
                   nodeWidth = 15, nodePadding = 10, height = 700, width = 600,
                   sinksRight = F)
# save the widget
...
ANCOM_barplot <- ggplot(marker_tab, aes(x = ef_CLR_diff_mean, 
  ...
  geom_text(aes(label = dif, x = ef_CLR_diff_mean + 0.1), 
            position = position_dodge(0.7), vjust = 0,size = 3) +
  scale_fill_manual(values = rep(c('#F39B7FFF','#DC0000FF','#00A087FF','grey','dimgrey','#3C5488FF','#8491B4FF'), 2)) +
  scale_x_continuous(expand = c(0, 0), limits = c(0, 2.2)) +
  ylab('') + xlab('CLR mean difference') +
  theme_bw()+
  theme(panel.grid=element_blank(), 
        axis.title = element_text(color = 'black', size = 8),
        axis.ticks.length = unit(0.15, "lines"), axis.ticks = element_line(color = 'black'),
...
# Combining Plots
library(cowplot)
venn_ANCOM_plots <- ggdraw() +
  draw_plot(venn_plots, x = 0, y = 0, width = 0.5, height = 1) +
  draw_plot(ANCOM_barplot, x = 0.5, y = 0.3, width = 0.5, height = 0.7) +
  draw_plot(single_dist_comparison, x = 0.5, y = 0, width = 0.5, height = 0.3)
venn_ANCOM_plots
```
