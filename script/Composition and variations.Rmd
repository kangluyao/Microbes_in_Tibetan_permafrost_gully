...
# Combining Plots
library(cowplot)
temp_right_plot <- plot_grid(ANCOM_barplot, single_dist_comparison, ncol = 1, rel_heights = c(0.7, 0.3), align = "v")
venn_ANCOM_plots <- plot_grid(venn_plots, temp_right_plot, ncol = 2, align = "h")
venn_ANCOM_plots
```
